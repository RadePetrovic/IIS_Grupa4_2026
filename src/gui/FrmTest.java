...
public class FrmTest extends JFrame {
	...
	public FrmTest() {
		...
		pnlNorth.setBackground(new Color(0, 204, 102));
		...
		cmbDodatneBoje.setModel(new DefaultComboBoxModel(new String[] { "Ljubicasta", "Zelena", "Narandzasta" }));
		...
		btnIzmeniBoju.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				DlgTest dlgTest = new DlgTest();
				try {
					String[] split = dlm.getElementAt(lstBoje.getSelectedIndex()).
							toString().split(" ");
					...
					JOptionPane.showMessageDialog(null, "Vrednosti moraju biti RGB!", 
